      ...
      <div class="pb-5 flex flex-col gap-2">
        ...
        <div class="flex flex-row flex-wrap gap-4">
          <div class="flex flex-row items-center gap-1">
            <input class="accent-teal-600" id="teacher" name="role" type="radio" value="teacher" v-model="role">
            <label for="teacher">Teacher/Official</label><br>
          </div>
          <div class="flex flex-row items-center gap-1">
            <input class="accent-teal-600" id="transport" name="role" type="radio" value="transport" v-model="role">
            <label for="transport">Transport Section</label><br>
          </div>
          <div class="flex flex-row items-center gap-1">
            <input class="accent-teal-600" id="driver" name="role" type="radio" value="driver" v-model="role">
